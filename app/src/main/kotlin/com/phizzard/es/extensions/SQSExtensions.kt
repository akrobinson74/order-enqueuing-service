...
fun getMessageRequest(
    ...
    .addMessageAttributesEntry(MESSAGE_CLASS, MessageAttributeValue().withDataType(STRING).withStringValue(msgClass))
    .addMessageAttributesEntry(PLATFORM_ID, MessageAttributeValue().withDataType(STRING).withStringValue(platformId))
